...
public class Peticion {
  // private int id;
  // private String descripcion, id_empleado, estado, cliente_solicitud,
  ...
  public static void createPeticion(String descripcion, String empleado, String remitente, String destinatario) {
    ...
    // DSL.field("descripcion"), DSL.field("id_empleado"), DSL.field("estado"),
    // DSL.field("cliente_solicitud"), DSL.field("cliente_destinatario"))
